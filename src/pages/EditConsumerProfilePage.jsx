...
/**
 * UI-13: Pantalla de modificación de perfil para Consumidor.
 ...
 * - Acceso exclusivo para rol "Consumidor" (guard en App.jsx via ProtectedRoute).
 */
export const EditConsumerProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await perfilService.modificarPerfilConsumidor(payload);
      // 204 No Content — camino feliz: redirigir al Home Consumidor (UI-02)
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={styles.grid}>
              <div style={styles.formGroup}>
                <label htmlFor="capodo" style={styles.label}>
                  Modificar el Apodo
                </label>
                <input
                  id="capodo"
            ...
            <div style={styles.buttonRow}>
              <button
                id="btn-registrar-perfil-consumidor"
                type="submit"
                disabled={isLoading}
                style={{
                  ...styles.submitBtn,

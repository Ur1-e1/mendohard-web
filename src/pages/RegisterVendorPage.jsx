          ...
          <section>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <input type="password" name="Contrasena" placeholder="••••••••" value={formData.Contrasena} onChange={handleChange} style={getInputStyle('Contrasena')} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label style={{ color: '#334155', fontSize: '0.9rem', fontWeight: 'bold' }}>Confirmar Contraseña</label>
                <input type="password" name="ConfirmacionContrasena" placeholder="••••••••" value={formData.ConfirmacionContrasena} onChange={handleChange} style={getInputStyle('ConfirmacionContrasena')} />
              </div>
            </div>
          </section>
